      ...
      <nav className="navbar navbar-expand-lg navbar-light" >
        ...
        <div id="navbarNavAltMarkup" className="col-md-8 collapse navbar-collapse">
          <div className="navbar-nav text-right text-md-center mx-auto">
            <button type="button" className="nav-item nav-link" href="#" onClick={() => this.props.displayWhat('bikes')}>Prendre un vélo</button>
            <a className="nav-item nav-link" href="#" onClick={() => this.props.displayWhat('freeSpaces')}>Déposer un vélo</a>
